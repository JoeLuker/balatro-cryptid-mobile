...
object Oracle {
    ...
    private val cases = listOf(
        ...
        Case("Pair of aces + marble (spawn → score unchanged) → 64", PlayingCard.hand("S_A", "H_A"), 64.0, j(FJoker("j_marble"))),
        Case("Pair of aces + vagabond (on-play spawn → score unchanged) → 64", PlayingCard.hand("S_A", "H_A"), 64.0, j(FJoker("j_vagabond"))),
        ...
        Case("Pair of aces + cry_gardenfork (economy → score unchanged) → 64", PlayingCard.hand("S_A", "H_A"), 64.0, j(FJoker("j_cry_gardenfork"))),
        Case("Pair of aces + cry_hunger (economy → score unchanged) → 64", PlayingCard.hand("S_A", "H_A"), 64.0, j(FJoker("j_cry_hunger"))),
        Case("Pair of aces + cry_lucky_joker (economy → score unchanged) → 64", PlayingCard.hand("S_A", "H_A"), 64.0, j(FJoker("j_cry_lucky_joker"))),
        Case("Pair of aces + cry_lebaron_james (hand-size → score unchanged) → 64", PlayingCard.hand("S_A", "H_A"), 64.0, j(FJoker("j_cry_lebaron_james"))),
        Case("Pair of aces + cry_coin (sell-economy → score unchanged) → 64", PlayingCard.hand("S_A", "H_A"), 64.0, j(FJoker("j_cry_coin"))),
        Case("Pair of aces + cry_happy (sell-spawn → score unchanged) → 64", PlayingCard.hand("S_A", "H_A"), 64.0, j(FJoker("j_cry_happy"))),
