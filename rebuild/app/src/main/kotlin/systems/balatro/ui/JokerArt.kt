...
object JokerArt {
    ...
    private val MAP: Map<String, Triple<String, Int, Int>> = mapOf(
        ...
        // Batch: remaining CATALOG jokers whose atlas is already bundled (atlas+pos verified against
        // mods/Cryptid/items/*.lua and game.lua; all in-bounds for the cell grid).
        "j_acrobat" to Triple("Jokers.png", 2, 1),
        "j_mystic_summit" to Triple("Jokers.png", 2, 2),
        "j_cry_apjoker" to Triple("atlasone.png", 2, 0),
        "j_cry_chad" to Triple("atlasone.png", 0, 3),
        "j_cry_clockwork" to Triple("atlasone.png", 5, 5),
        "j_cry_dropshot" to Triple("atlasone.png", 5, 0),
        "j_cry_fading_joker" to Triple("atlasone.png", 2, 6),
        "j_cry_foodm" to Triple("atlasone.png", 4, 2),
        "j_cry_poor_joker" to Triple("atlasone.png", 3, 6),
        "j_cry_spaceglobe" to Triple("atlasone.png", 1, 4),
        "j_cry_broken_sync_catalyst" to Triple("atlastwo.png", 6, 3),
        "j_cry_chili_pepper" to Triple("atlastwo.png", 0, 1),
        "j_cry_flip_side" to Triple("atlastwo.png", 3, 6),
        "j_cry_loopy" to Triple("atlastwo.png", 7, 0),
        "j_cry_mondrian" to Triple("atlastwo.png", 5, 3),
        "j_cry_mstack" to Triple("atlastwo.png", 2, 3),
        "j_cry_sock_and_sock" to Triple("atlastwo.png", 6, 6),
        "j_cry_adroit" to Triple("atlasthree.png", 7, 4),
        "j_cry_cut" to Triple("atlasthree.png", 2, 2),
        "j_cry_longboi" to Triple("atlasthree.png", 5, 4),
        "j_cry_many_lost_minds" to Triple("atlasthree.png", 7, 7),
        "j_cry_nebulous" to Triple("atlasthree.png", 4, 7),
        "j_cry_penetrating" to Triple("atlasthree.png", 7, 3),
        "j_cry_python" to Triple("atlasthree.png", 4, 2),
        "j_cry_thalia" to Triple("atlasthree.png", 0, 8),
        "j_cry_treacherous" to Triple("atlasthree.png", 8, 3),
        "j_cry_undefined" to Triple("atlasthree.png", 3, 7),
        "j_cry_circulus_pistoris" to Triple("atlasexotic.png", 0, 3),
