LOVELY_INTEGRITY = 'df3e68946c08bdb16b92d29cf0dd217a51e347c95407d69f915d252c6ba1e564'
...
function Sprite:draw_shader(_shader, _shadow_height, _send, _no_tilt, other_obj, ms, mr, mx, my, custom_shader, tilt_shadow)
    ...
    elseif _shader == 'vortex' then 
        ...
        G.SHADERS[_shader or 'dissolve']:send('screen_scale', (_draw_major.mouse_damping or 1) * (G._DRAW_SCREEN_SCALE or G.TILESCALE*G.TILESIZE*G.CANV_SCALE))
        ...
        G.SHADERS[_shader or 'dissolve']:send("time", _draw_major.ARGS.shader_time or 123.33412*(_draw_major.ID/1.14212)%3000)
