LOVELY_INTEGRITY = '21750447f6b2a9eddd1b8ffa6e7aeaaaf27742e94c5d62e30057a282ce1777c3'
...
function Card:init(X, Y, W, H, card, center, params)
    ...
    -- Cache the ID-derived shader time value: 123.33412*(ID/1.14212)%3000 is
    -- purely a function of self.ID, which is assigned once in Node:init and
    -- never changes.  Storing it here avoids recomputing and re-sending it to
    -- the GPU driver on every draw_shader call (~4000×/frame).
    self.ARGS.shader_time = 123.33412*(self.ID/1.14212)%3000
