LOVELY_INTEGRITY = '6fe624436b3c8f79c0d005f62606ced56c48f1619044bbfdbc0aaabdba5f2b4a'
        ...
        if G.GAME.current_round.semicolon then
            ...
            if game_over then
                ...
                if G.GAME.blind_on_deck == 'Boss' then
                    ...
                    delay(0.4); SMODS.ante_end = true; ease_ante(1); Cryptid.apply_ante_tax(); SMODS.ante_end = nil; delay(0.4); check_for_unlock({type = 'ante_up', ante = G.GAME.round_resets.ante + 1})
                end
