...
function Tag:set_ability()
    ...
    if self.name == 'Orbital Tag' then
        ...
        elseif self.ability.blind_type then
            if G.GAME.orbital_choices and G.GAME.orbital_choices[to_number(G.GAME.round_resets.ante)][self.ability.blind_type] then
                self.ability.orbital_hand = G.GAME.orbital_choices[to_number(G.GAME.round_resets.ante)][self.ability.blind_type]       
            end
        end
